...
<xmod:Template runat="server" ID="SellerTemplate" UsePaging="True" Ajax="True" AddRoles="Administrators" EditRoles="Administrators" DeleteRoles="Administrators" DetailRoles="Administrators">
  ...
  <CustomCommands>
    <DataCommand CommandName="SoftDeleteSeller" CommandText="IF 0 = (SELECT [IsDeleted] FROM XMP_Classified_Seller WHERE [SellerID] = @SellerID)
                                                              UPDATE XMP_Classified_Seller SET [IsDeleted]=1,[Date_Updated]=getdate(),[UpdatedBy]=@UserID WHERE [SellerID] = @SellerID
                                                             ELSE
                                                              UPDATE XMP_Classified_Seller SET [IsDeleted]=0,[Date_Updated]=getdate(),[UpdatedBy]=@UserID WHERE [SellerID] = @SellerID">
      <Parameter Name="SellerID" />
      <Parameter Name="UserID" />
    </DataCommand>
    <DataCommand CommandName="BanSeller" CommandText="IF 0 = (SELECT [Banned] FROM XMP_Classified_Seller WHERE [SellerID] = @SellerID)
                                                              UPDATE XMP_Classified_Seller SET [Banned]=1,[Date_Updated]=getdate(),[UpdatedBy]=@UserID WHERE [SellerID] = @SellerID
                                                             ELSE
                                                              UPDATE XMP_Classified_Seller SET [Banned]=0,[Date_Updated]=getdate(),[UpdatedBy]=@UserID WHERE [SellerID] = @SellerID">
      <Parameter Name="SellerID" />
      <Parameter Name="UserID" />
    </DataCommand>
            ...
            <xmod:Select runat="server" Mode="Standard">
                ...
                <div class="btn-group" role="group">
                  ...
                  <ul class="dropdown-menu" role="group">
                        ...
                        <li>
                          <xmod:CommandLink runat="server" Text="Toggle Soft Delete" CssClass="btn btn-xs btn-default">
                        ...
                        <li>
                          <xmod:CommandLink runat="server" Text="Toggle Ban Seller" CssClass="btn btn-xs btn-default">
