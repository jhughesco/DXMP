...
<xmod:Template runat="server" ID="LevelTemplate" UsePaging="True" Ajax="True" AddRoles="" EditRoles="" DeleteRoles="">
  <ListDataSource CommandText="SELECT [LevelID]
                                  ,[Level_Name]
                                  ,[Level_Description]
                                  ,[Level_Price]
  ...
  <CustomCommands>
		<DataCommand CommandName="DeleteLvl" CommandText="DELETE FROM XMP_Classified_Level WHERE [LevelID] = @LevelID">
              ...
              <ul class="dropdown-menu" role="menu">
                <xmod:Select runat="server" Mode="Standard">
              	...
              	<xmod:Select runat="server" Mode="Standard">
                    ...
                    <li>
                      <xmod:CommandLink runat="server" Text="Delete Level" CssClass="btn btn-xs btn-danger" OnClientClick="return confirm('Are you sure?');">
                        <Command Name="DeleteLvl" Type="Custom">
                          <Parameter Name="LevelID" Value='<%#Eval("Values")("LevelID")%>' DataType="Int32" />
                        </Command>
                      </xmod:CommandLink>
                    </li>
