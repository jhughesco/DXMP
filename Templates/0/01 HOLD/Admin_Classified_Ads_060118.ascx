...
<xmod:ScriptBlock runat="server" ScriptId="SellerCSS" BlockType="HeadScript" RegisterOnce="False">
  ...
  <style type="text/css">
    ...
    .summary-wrapper .adsummary-wrapper p { font-size:16px; color: #555; border: 4px solid #ebebeb; padding 20px; }
            ...
            <div class="tab-pane active" id="summary" role="tabpanel" aria-labelledby="summary-tab">
                ...
                <div class="row adsummary-wrapper">
                  <div class="panel panel-default">
                  	<div class="panel-heading"><%#Eval("Values")("Ad_Summary")%>;</div>
                	</div>
                </div>
                    ...
                    <div class="media">
                      <a class="media-left" href="#">
                        ...
                        <xmod:IfEmpty runat="server" Value='<%#Eval("Values")("Seller_Image")%>'>
                          <img class="img-thumbnail" src="http://placehold.it/100&text=no+image" style="max-width: 100px" alt="NoSellerImage">
                        </xmod:IfEmpty>    
                      </a>
                    </div>
                  </div>
