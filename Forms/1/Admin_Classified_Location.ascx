...
<xmod:FormView runat="server"><AddItemTemplate><xmod:AddForm runat="server">
  <ScriptBlock BlockType="HeadScript" RegisterOnce="True" ScriptId="KBXM_Theme_none_Admin_Classified_Location">
  ...
  <SubmitCommand CommandText="INSERT INTO [XMP_Classified_Location] ([City], [State]) VALUES(@City, @State) " /><div class="xmp-form xmp-Admin_Classified_Location">
    <div class="xmp-form-row"><Label CssClass="xmp-form-label" For="City">City</Label><TextBox Id="City" Width="165" MaxLength="25" DataField="City" DataType="string"></TextBox></div>
    <div class="xmp-form-row"><Label CssClass="xmp-form-label" For="State">State</Label><TextBox Id="State" Width="35" MaxLength="5" DataField="State" DataType="string"></TextBox></div><ValidationSummary CssClass="xmp-validation" Id="vsXMP_Classified_Location"></ValidationSummary><div class="xmp-form-row"><Label class="xmp-form-label">&nbsp;</Label><AddButton Text="Add"></AddButton><CancelButton Text="Cancel" style="margin-left: 12px;" Visible="true"></CancelButton></div>
  ...
  <SelectCommand CommandText="SELECT [City], [State], [LocationID] FROM XMP_Classified_Location WHERE [LocationID]=@LocationID" />  <SubmitCommand CommandText="UPDATE [XMP_Classified_Location] SET [City]=@City, [State]=@State WHERE [LocationID]=@LocationID" /><div class="xmp-form xmp-Admin_Classified_Location">
    <div class="xmp-form-row"><Label CssClass="xmp-form-label" For="City">City</Label><TextBox Id="City" Width="165" MaxLength="25" DataField="City" DataType="string"></TextBox></div>
    <div class="xmp-form-row"><Label CssClass="xmp-form-label" For="State">State</Label><TextBox Id="State" Width="35" MaxLength="5" DataField="State" DataType="string"></TextBox></div><ValidationSummary CssClass="xmp-validation" Id="vsXMP_Classified_Location"></ValidationSummary><div class="xmp-form-row"><Label class="xmp-form-label">&nbsp;</Label><UpdateButton Text="Update"></UpdateButton><CancelButton Text="Cancel" style="margin-left: 12px;" Visible="true"></CancelButton></div>
